...
import { startOnboardingAction, type FormState } from "./actions";
...
export function StartOnboardingForm() {
  const [state, formAction, isPending] = useActionState(startOnboardingAction, initialState);
      ...
      <CardContent>
        <form action={formAction} className="space-y-4">
          ...
          <Button type="submit" className="w-full" disabled={isPending}>
            {isPending ? "Creating your dealership…" : "Create my dealership"}
          </Button>
        </form>
